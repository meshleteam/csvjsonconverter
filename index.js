...
(function () {
    ...
    errorEmpty = "Empty CSV. Please provide something.", errorEmptyHeader = "Could not detect header. Ensure first row contains your column headers.", separators = [",", ";", "\t"], pegjsSeparatorNames = {
        ",": "comma",
        ";": "semicolon",
        "\t": "tab",
    };
    ...
    function convert(csv, options) {
        ...
        if (Array.isArray(a) && options.transpose)
            a = zip.apply(null, a);
        if (Array.isArray(a))
            var keys = a.shift();
        ...
        var result = {
            ...
            parse: function (input, startRule) {
                ...
                if (result === null || pos !== input.length) {
                    ...
                    if (this.SyntaxError)
                        throw this.SyntaxError(cleanupExpected(rightmostFailuresExpected), found, offset, errorPosition.line, errorPosition.column);
                    else
